...
public class JHyperlinkLabelBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_failureMessagesAreShown = 29;
    ...
    private static final int PROPERTY_selectedHyperlinkColor = 92;
    ...
    private static final int PROPERTY_toolTipTextSet = 98;
    ...
    private static final int PROPERTY_unvisitedHyperlinkColor = 104;
    private static final int PROPERTY_URI = 105;
    ...
    private static final int PROPERTY_visited = 114;
    private static final int PROPERTY_visitedHyperlinkColor = 115;
