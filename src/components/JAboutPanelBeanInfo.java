...
public class JAboutPanelBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_activatedHyperlinkColor = 3;
    private static final int PROPERTY_activatedHyperlinkColorSet = 4;
    ...
    private static final int PROPERTY_bottomAccessory = 13;
    private static final int PROPERTY_bounds = 14;
    private static final int PROPERTY_closeButton = 15;
    private static final int PROPERTY_closeButtonText = 16;
    private static final int PROPERTY_closeButtonTextSet = 17;
    ...
    private static final int PROPERTY_controlButtonsAreShown = 26;
    private static final int PROPERTY_creditsDocument = 27;
    private static final int PROPERTY_creditsEditorKit = 28;
    private static final int PROPERTY_creditsInheritsPopupMenu = 29;
    private static final int PROPERTY_creditsPopupMenu = 30;
    private static final int PROPERTY_creditsScrollPane = 31;
    private static final int PROPERTY_creditsText = 32;
    private static final int PROPERTY_creditsTextPane = 33;
    private static final int PROPERTY_cursor = 34;
    private static final int PROPERTY_cursorSet = 35;
    private static final int PROPERTY_debugGraphicsOptions = 36;
    ...
    private static final int PROPERTY_failureMessagesAreShown = 41;
    ...
    private static final int PROPERTY_licenseButton = 72;
    private static final int PROPERTY_licenseButtonIsShown = 73;
    ...
    private static final int PROPERTY_mixingCutoutShape = 83;
    ...
    private static final int PROPERTY_programCopyright = 97;
    private static final int PROPERTY_programCopyrightLabel = 98;
    private static final int PROPERTY_programIcon = 99;
    private static final int PROPERTY_programIconLabel = 100;
    private static final int PROPERTY_programName = 101;
    private static final int PROPERTY_programNameLabel = 102;
    private static final int PROPERTY_programVersion = 103;
    private static final int PROPERTY_programVersionLabel = 104;
    private static final int PROPERTY_programWebsiteLabel = 105;
    private static final int PROPERTY_programWebsiteText = 106;
    private static final int PROPERTY_programWebsiteURI = 107;
    private static final int PROPERTY_programWebsiteVisited = 108;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_activatedHyperlinkColor] = new PropertyDescriptor ( "activatedHyperlinkColor", components.JAboutPanel.class, "getActivatedHyperlinkColor", "setActivatedHyperlinkColor" ); // NOI18N
            ...
            properties[PROPERTY_activatedHyperlinkColorSet] = new PropertyDescriptor ( "activatedHyperlinkColorSet", components.JAboutPanel.class, "isActivatedHyperlinkColorSet", null ); // NOI18N
